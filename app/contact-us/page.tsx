  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <MotionInView className="rounded-2xl border border-gray-800 bg-surface/30 p-6 md:p-8 mb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <MotionInView className="rounded-2xl border border-gray-800 bg-surface/40 p-8">
          ...
          <MotionInView className="rounded-2xl border border-gray-800 bg-surface/40 p-8" delay={0.05}>
